...
then
  ...
  sudo fio --directory=/raid/fiotest --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randread --rwmixread=0 --bs=128K --iodepth=6 --numjobs=1
...
then
  ...
  sudo mkdir /raid/fiotest
  sudo mdadm /dev/md0 -f /dev/nvme2n1
  sudo fio --directory=/raid/fiotest --size=2048M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randread --rwmixread=0 --bs=128K --iodepth=4 --numjobs=1
  sudo rm -r /raid/fiotest
  sudo umount /raid
  sudo mdadm -S /dev/md0
  sudo mdadm --zero-superblock /dev/nvme2n1
...
then
  ...
  sudo mkdir /raid/fiotest
  sudo mdadm /dev/md0 -f /dev/nvme2n1
  sudo fio --directory=/raid/fiotest --size=2048M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randread --rwmixread=0 --bs=128K --iodepth=3 --numjobs=1
  sudo rm -r /raid/fiotest
  sudo umount /raid
  sudo mdadm -S /dev/md0
  sudo mdadm --zero-superblock /dev/nvme2n1
